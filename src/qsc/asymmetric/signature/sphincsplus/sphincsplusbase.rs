...
pub const SPX_N: usize = if QSC_SPHINCSPLUS_S3S192SHAKERF {
    24
...
pub const SPX_FULL_HEIGHT: usize = if QSC_SPHINCSPLUS_S3S192SHAKERF {
    66
} else if QSC_SPHINCSPLUS_S3S192SHAKERS {
    63
} else if QSC_SPHINCSPLUS_S5S256SHAKERF {
...
pub const SPX_D: usize = if QSC_SPHINCSPLUS_S3S192SHAKERF {
    22
} else if QSC_SPHINCSPLUS_S3S192SHAKERS {
    7
} else if QSC_SPHINCSPLUS_S5S256SHAKERF {
...
pub const SPX_FORS_HEIGHT: usize = if QSC_SPHINCSPLUS_S3S192SHAKERF {
    8
} else if QSC_SPHINCSPLUS_S3S192SHAKERS {
    14
} else if QSC_SPHINCSPLUS_S5S256SHAKERF {
...
pub const SPX_FORS_TREES: usize = if QSC_SPHINCSPLUS_S3S192SHAKERF {
    33
} else if QSC_SPHINCSPLUS_S3S192SHAKERS {
    17
} else if QSC_SPHINCSPLUS_S5S256SHAKERF {
...
pub const SPX_WOTS_W: usize = if QSC_SPHINCSPLUS_S3S192SHAKERF {
    16
} else if QSC_SPHINCSPLUS_S3S192SHAKERS {
    16
} else if QSC_SPHINCSPLUS_S5S256SHAKERF {
...
pub const SPHINCSPLUS_CRYPTO_SEEDBYTES: usize = 3 * SPX_N;

/* utils.c */

pub fn sphincsplus_ull_to_bytes(out: &mut [u8], outlen: u32, mut int: u64) {
    let mut pos = outlen;
...
pub fn sphincsplus_u32_to_bytes(out: &mut [u8], int: u32) {
    out[0] = (int >> 24) as u8;
    out[1] = (int >> 16) as u8;
    out[2] = (int >> 8) as u8;
    out[3] = int as u8;
...
pub fn sphincsplus_bytes_to_ull(int: &[u8], inlen: u32) -> u64 {
    let mut ret: u64 = 0;
...
pub fn sphincsplus_set_layer_addr(addr: &mut [u32; 8], layer: u32) {
...
pub fn sphincsplus_set_tree_addr(addr: &mut [u32; 8], tree: u64) {
...
pub fn sphincsplus_set_type(addr: &mut [u32; 8], type_var: u32) {
...
pub fn sphincsplus_copy_subtree_addr(out: &mut [u32; 8], int: &mut [u32; 8]) {
...
pub fn sphincsplus_set_keypair_addr(addr: &mut [u32; 8], keypair: u32) {
...
pub fn sphincsplus_copy_keypair_addr(out: &mut [u32; 8], int: [u32; 8]) {
...
pub fn sphincsplus_set_chain_addr(addr: &mut [u32; 8], chain: u32) {
...
pub fn sphincsplus_set_hash_addr(addr: &mut [u32; 8], hash: u32) {
...
pub fn sphincsplus_set_tree_height(addr: &mut [u32; 8], tree_height: u32) {
...
pub fn sphincsplus_set_tree_index(addr: &mut [u32; 8], tree_index: u32) {
...
/* hash_shake256.c */
*/
pub fn sphincsplus_prf_addr(out: &mut [u8], key: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_gen_message_random(r: &mut [u8], sk_prf: &[u8], optrand: &[u8], m: &[u8], mlen: u64) {
...
pub fn sphincsplus_hash_message(digest: &mut [u8], tree: &mut u64, leaf_idx: &mut u32, r: &[u8], pk: &[u8], m: &[u8], mlen: u64) {
...
pub fn sphincsplus_thash(out: &mut [u8], int: &[u8], inblocks: u32, pubseed: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_compute_root(root: &mut [u8], leaf: &[u8], mut leaf_idx: u32, mut idx_offset: u32, mut auth_path: &[u8], tree_height: u32, pubseed: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_treehash(root: &mut [u8], auth_path: &mut [u8], sk_seed: &[u8], pubseed: &[u8], leaf_idx: u32, idx_offset: u32, tree_height: u32,
...
pub fn sphincsplus_fors_gen_sk(sk: &mut [u8], sk_seed: &[u8], fors_leaf_addr: &mut [u32; 8]) {
    sphincsplus_prf_addr(sk, sk_seed, fors_leaf_addr);
}

pub fn sphincsplus_fors_sk_to_leaf(leaf: &mut [u8], sk: &[u8], pubseed: &[u8], fors_leaf_addr: &mut [u32; 8]) {
    sphincsplus_thash(leaf, sk, 1, pubseed, fors_leaf_addr);
}

pub fn sphincsplus_fors_gen_leaf(leaf: &mut [u8], sk_seed: &[u8], pubseed: &[u8], addr_idx: u32, fors_tree_addr: &mut [u32; 8]) {
...
pub fn sphincsplus_message_to_indices(indices: &mut [u32], m: &[u8]) {
...
pub fn sphincsplus_fors_sign(mut sig: &mut [u8], pk: &mut [u8], m: &[u8], sk_seed: &[u8], pubseed: &[u8], fors_addr: [u32; 8]) {
...
pub fn sphincsplus_fors_pk_from_sig(pk: &mut [u8], mut sig: &[u8], m: &[u8], pubseed: &[u8], fors_addr: [u32; 8]) {
...
pub fn sphincsplus_wots_gen_sk(sk: &mut [u8], sk_seed: &[u8], wots_addr: &mut [u32; 8]) {
...
pub fn sphincsplus_gen_chain(out: &mut [u8], int: &[u8], start: u32, steps: u32, pubseed: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_base_w(output: &mut [u32], out_len: usize, input: &[u8]) {
...
pub fn sphincsplus_wots_checksum(csum_base_w: &mut [u32], msg_base_w : &[u32]) {
...
pub fn sphincsplus_chain_lengths(lengths: &mut [u32], msg: &[u8]) {
...
pub fn sphincsplus_wots_gen_pk(pk: &mut [u8], sk_seed: &[u8], pubseed: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_wots_sign(sig: &mut [u8], msg: &[u8], sk_seed: &[u8], pubseed: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_wots_pk_from_sig(pk: &mut [u8], sig: &[u8], msg: &[u8], pubseed: &[u8], addr: &mut [u32; 8]) {
...
pub fn sphincsplus_wots_gen_leaf(leaf: &mut [u8], sk_seed: &[u8], pubseed: &[u8], addr_idx: u32, tree_addr: &mut [u32; 8]) {
...
*/
pub fn sphincsplus_ref_generate_seed_keypair(pk: &mut [u8], sk: &mut [u8], seed: &[u8]) -> i32 {
...
* \param rng_generate: A pointer to the random generator function
*/
pub fn sphincsplus_ref_sign_signature(mut sig: &mut [u8], siglen: &mut usize, m: &[u8], mlen: usize, sk: &[u8], rng_generate: fn(&mut [u8], usize) -> bool) {
...
*/
pub fn sphincsplus_ref_sign_verify(mut sig: &[u8], siglen: usize, m: &[u8], mlen: usize, pk: &[u8]) -> bool {
