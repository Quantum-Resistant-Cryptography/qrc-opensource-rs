...
*/
pub(crate) const QSC_SYSUTILS_SYSTEM_NAME_MAX: usize = 256;

/*
* \struct qsc_sysutils_drive_space_state
* \brief The drive_space state structure
*/
pub(crate) struct QscSysutilsDriveSpaceState {
	pub(crate) free: u64,		/*< The free drive space */
	pub(crate) total: u64,		/*< The total drive space */
	pub(crate) avail: u64,		/*< The available drive space */
} 
...
*/
pub(crate) struct QscSysutilsMemoryStatisticsState {
	pub(crate) phystotal: u64,		/*< The total physical memory */
	pub(crate) physavail: u64,	    /*< The available physical memory */
	pub(crate) virttotal: u64,     /*< The total virtual memory */
	pub(crate) virtavail: u64,	    /*< The available virtual memory */
}
...
*/
pub(crate) fn qsc_sysutils_computer_name(name: &mut String, maxlen: usize) -> usize{
...
*/
pub(crate) fn qsc_sysutils_drive_space(state: &mut QscSysutilsDriveSpaceState) {
...
*/
pub(crate) fn qsc_sysutils_memory_statistics(state: &mut QscSysutilsMemoryStatisticsState) {
...
*/
pub(crate) fn qsc_sysutils_process_id() -> u32 {
...
*/
pub(crate) fn qsc_sysutils_user_name(name: &mut String, maxlen: usize) -> usize{
...
*/
pub(crate) fn qsc_sysutils_system_uptime() -> u64 {
...
*/
pub(crate) fn qsc_sysutils_system_timestamp() -> u64 {
