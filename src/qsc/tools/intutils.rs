...
*/
pub(crate) fn qsc_intutils_be8increment(output: &mut [u8], outlen: usize) {
    let mut i = outlen;
...
*/
pub(crate) fn qsc_intutils_cmov(dest: &mut [u8], source: &[u8], length: usize, mut cond: u8) {
...
*/
pub(crate) fn qsc_intutils_be8to32(input: &[u8]) -> u32 {
...
*/
pub(crate) fn qsc_intutils_be8to64(input: &[u8]) -> u64 {
...
*/
pub(crate) fn qsc_intutils_be32to8(output: &mut [u8], value: u32) {
...
*/
pub(crate) fn qsc_intutils_be64to8(output: &mut [u8], value: u64) {
...
*/
pub(crate) fn qsc_intutils_clear8(a: &mut [u8], count: usize) {
	for i in 0..count {
		a[i] = 0;
	}
}
...
*/
pub(crate) fn qsc_intutils_clear32(a: &mut [u32], count: usize) {
	for i in 0..count {
		a[i] = 0;
	}
}
...
*/
pub(crate) fn qsc_intutils_clear64(a: &mut [u64], count: usize) {
	for i in 0..count {
		a[i] = 0;
	}
}
...
* \param outlen: The length of the output counter array
*/
pub(crate) fn qsc_intutils_le8increment(output: &mut [u8], outlen: usize) {
	for i in 0..outlen {
		if output[i] == 255 {
			output[i] = 0;
		} else {
...
*/
pub(crate) fn qsc_intutils_le8to32(input: &[u8]) -> u32 {
...
*/
pub(crate) fn qsc_intutils_le8to64(input: &[u8]) -> u64 {
...
* \param value: The 32-bit integer
*/
pub(crate) fn qsc_intutils_le32to8(output: &mut [u8], value: u32) {
...
* \param value: The 64-bit integer
*/
pub(crate) fn qsc_intutils_le64to8(output: &mut [u8], value: u64) {
	output[0] = value as u8 & 0xFF;
	output[1] = (value >> 8) as u8 & 0xFF;
	output[2] = (value >> 16) as u8 & 0xFF;
	output[3] = (value >> 24) as u8 & 0xFF;
...
*/
pub(crate) fn qsc_intutils_min(a: usize, b: usize) -> usize {
...
*/
pub(crate) fn qsc_intutils_rotl64(value: u64, shift: usize) -> u64 {
	return (value << shift) | (value >> ((size_of::<u64>() * 8) - shift));
}


pub(crate) fn qsc_intutils_verify(a: &[u8], b: &[u8], length: usize) -> i32 {
	let mut d: u16 = 0;
