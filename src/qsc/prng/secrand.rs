...
pub struct QscSecrandState {
    pub hstate: QscCsgState,                  /*< The CSG state */
    pub cache: [u8; QSC_SECRAND_CACHE_SIZE],    /*< The cache buffer */
...
*/
pub fn qsc_secrand_destroy(secrand_state: &mut QscSecrandState) {
...
*/
pub fn qsc_secrand_initialize(secrand_state: &mut QscSecrandState, seed: &[u8], seedlen: usize, custom: &[u8], custlen: usize) {
...
*/
pub fn qsc_secrand_generate(secrand_state: &mut QscSecrandState, output: &mut [u8], mut length: usize) -> bool {
