...
use crate::{asymmetric::signature::ecdsa::{QRC_ECDSA_PUBLICKEY_SIZE, QRC_ECDSA_SEED_SIZE, QRC_ECDSA_SIGNATURE_SIZE}, tools::intutils::{qrc_intutils_clear32i, qrc_intutils_copy32i}};
use core::mem::size_of;

pub const QRC_EC25519_SEED_SIZE: usize = QRC_ECDSA_SEED_SIZE;
pub const QRC_EC25519_SIGNATURE_SIZE: usize = QRC_ECDSA_SIGNATURE_SIZE;
pub const QRC_EC25519_PUBLICKEY_SIZE: usize = QRC_ECDSA_PUBLICKEY_SIZE;
//pub const QRC_EC25519_PRIVATEKEY_SIZE: usize = QRC_ECDSA_PRIVATEKEY_SIZE;
pub const QRC_EC25519_CURVE_SIZE: u32 = 32;

//pub const QRC_EC25519_ALGNAME: &str = "EC25519";

/* fe */
pub type Fe25519 = [i32; 10];

pub fn fe25519_0(h: &mut Fe25519) {
	qrc_intutils_clear32i(h, 10 * size_of::<i32>());
}
...
pub fn fe25519_mul(h: &mut Fe25519, f: Fe25519, g: Fe25519) {
	...
	let mut h0 = (f0 * g0) + (f1x2 * g9x19) + (f2 * g8x19) + (f3x2 * g7x19) + (f4 * g6x19) + (f5x2 * g5x19) + (f6 * g4x19) + (f7x2 * g3x19) + (f8 * g2x19) + (f9x2 * g1x19);
	let mut h1 = (f0 * g1) + (f1 * g0) + (f2 * g9x19) + (f3 * g8x19) + (f4 * g7x19) + (f5 * g6x19) + (f6 * g5x19) + (f7 * g4x19) + (f8 * g3x19) + (f9 * g2x19);
	let mut h2 = (f0 * g2) + (f1x2 * g1) + (f2 * g0) + (f3x2 * g9x19) + (f4 * g8x19) + (f5x2 * g7x19) + (f6 * g6x19) + (f7x2 * g5x19) + (f8 * g4x19) + (f9x2 * g3x19);
	let mut h3 = (f0 * g3) + (f1 * g2) + (f2 * g1) + (f3 * g0) + (f4 * g9x19) + (f5 * g8x19) + (f6 * g7x19) + (f7 * g6x19) + (f8 * g5x19) + (f9 * g4x19);
	let mut h4 = (f0 * g4) + (f1x2 * g3) + (f2 * g2) + (f3x2 * g1) + (f4 * g0) + (f5x2 * g9x19) + (f6 * g8x19) + (f7x2 * g7x19) + (f8 * g6x19) + (f9x2 * g5x19);
	let mut h5 = (f0 * g5) + (f1 * g4) + (f2 * g3) + (f3 * g2) + (f4 * g1) + (f5 * g0) + (f6 * g9x19) + (f7 * g8x19) + (f8 * g7x19) + (f9 * g6x19);
	let mut h6 = (f0 * g6) + (f1x2 * g5) + (f2 * g4) + (f3x2 * g3) + (f4 * g2) + (f5x2 * g1) + (f6 * g0) + (f7x2 * g9x19) + (f8 * g8x19) + (f9x2 * g7x19);
	let mut h7 = (f0 * g7) + (f1 * g6) + (f2 * g5) + (f3 * g4) + (f4 * g3) + (f5 * g2) + (f6 * g1) + (f7 * g0) + (f8 * g9x19) + (f9 * g8x19);
	let mut h8 = (f0 * g8) + (f1x2 * g7) + (f2 * g6) + (f3x2 * g5) + (f4 * g4) + (f5x2 * g3) + (f6 * g2) + (f7x2 * g1) + (f8 * g0) + (f9x2 * g9x19);
	let mut h9 = (f0 * g9) + (f1 * g8) + (f2 * g7) + (f3 * g6) + (f4 * g5) + (f5 * g4) + (f6 * g3) + (f7 * g2) + (f8 * g1) + (f9 * g0);

	/* |h0| <= (1.65*1.65*2^52*(1+19+19+19+19)+1.65*1.65*2^50*(38+38+38+38+38))
	 i.e. |h0| <= 1.4*2^60; narrower ranges for h2, h4, h6, h8
	 |h1| <= (1.65*1.65*2^51*(1+1+19+19+19+19+19+19+19+19))
	 i.e. |h1| <= 1.7*2^59; narrower ranges for h3, h5, h7, h9 */
	let mut carry = (h0 + (1 << 25)) >> 26;
	h1 += carry;
	h0 -= carry * (1 << 26);
	carry = (h4 + (1 << 25)) >> 26;
	h5 += carry;
...
pub fn fe25519_sq(h: &mut Fe25519, f: Fe25519) {
	...
	let f1f1x2 = f1x2 * f1;
	let f1f2x2 = f1x2 * f2;
	let f1f3x4 = f1x2 * f3x2;
	let f1f4x2 = f1x2 * f4;
	let f1f5x4 = f1x2 * f5x2;
	let f1f6x2 = f1x2 * f6;
	let f1f7x4 = f1x2 * f7x2;
	let f1f8x2 = f1x2 * f8;
	let f1f9x76 = f1x2 * f9x38;

	let mut h0 = f0f0 + f1f9x76 + (f2x2 * f8x19) + (f3x2 * f7x38) + (f4x2 * f6x19) + (f5 * f5x38);
	let mut h1 = f0f1x2 + (f2 * f9x38) + (f3x2 * f8x19) + (f4 * f7x38) + (f5x2 * f6x19);
	let mut h2 = f0f2x2 + f1f1x2 + (f3x2 * f9x38) + (f4x2 * f8x19) + (f5x2 * f7x38) + (f6 * f6x19);
	let mut h3 = f0f3x2 + f1f2x2 + (f4 * f9x38) + (f5x2 * f8x19) + (f6 * f7x38);
	let mut h4 = f0f4x2 + f1f3x4 + (f2 * f2) + (f5x2 * f9x38) + (f6x2 * f8x19) + (f7 * f7x38);
	let mut h5 = f0f5x2 + f1f4x2 + (f2x2 * f3) + (f6 * f9x38) + (f7x2 * f8x19);
	let mut h6 = f0f6x2 + f1f5x4 + (f2x2 * f4) + (f3x2 * f3) + (f7x2 * f9x38) + (f8 * f8x19);
	let mut h7 = f0f7x2 + f1f6x2 + (f2x2 * f5) + (f3x2 * f4) + (f8 * f9x38);
	let mut h8 = f0f8x2 + f1f7x4 + (f2x2 * f6) + (f3x2 * f5x2) + (f4 * f4) + (f9 * f9x38);
	let mut h9 = f0f9x2 + f1f8x2 + (f2x2 * f7) + (f3x2 * f6) + (f4x2 * f5);
...
pub fn fe25519_sq2(h: &mut Fe25519, f: Fe25519) {
	...
	*/
	...
	let mut h0 = (f0 * f0) + (f1x2 * f9x38) + (f2x2 * f8x19) + (f3x2 * f7x38) + (f4x2 * f6x19) + (f5 * f5x38);
	let mut h1 = (f0x2 * f1) + (f2 * f9x38) + (f3x2 * f8x19) + (f4 * f7x38) + (f5x2 * f6x19);
	let mut h2 = (f0x2 * f2) + (f1x2 * f1) + (f3x2 * f9x38) + (f4x2 * f8x19) + (f5x2 * f7x38) + (f6 * f6x19);
	let mut h3 = (f0x2 * f3) + (f1x2 * f2) + (f4 * f9x38) + (f5x2 * f8x19) + (f6 * f7x38);
	let mut h4 = (f0x2 * f4) + (f1x2 * f3x2) + (f2 * f2) + (f5x2 * f9x38) + (f6x2 * f8x19) + (f7 * f7x38);
	let mut h5 = (f0x2 * f5) + (f1x2 * f4) + (f2x2 * f3) + (f6 * f9x38) + (f7x2 * f8x19);
	let mut h6 = (f0x2 * f6) + (f1x2 * f5x2) + (f2x2 * f4) + (f3x2 * f3) + (f7x2 * f9x38) + (f8 * f8x19);
	let mut h7 = (f0x2 * f7) + (f1x2 * f6) + (f2x2 * f5) + (f3x2 * f4) + (f8 * f9x38);
	let mut h8 = (f0x2 * f8) + (f1x2 * f7x2) + (f2x2 * f6) + (f3x2 * f5x2) + (f4 * f4) + (f9 * f9x38);
	let mut h9 = (f0x2 * f9) + (f1x2 * f8) + (f2x2 * f7) + (f3x2 * f6) + (f4x2 * f5);
...
pub fn fe25519_invert(out: &mut Fe25519, z: Fe25519) {
	...
	let t0 = &mut Fe25519::default();
	let t1 = &mut Fe25519::default();
	let t2 = &mut Fe25519::default();
	let t3 = &mut Fe25519::default();

	fe25519_sq(t0, z);
	fe25519_sq(t1, t0.clone());
	fe25519_sq(t1, t1.clone());
	fe25519_mul(t1, z, t1.clone());
	fe25519_mul(t0, t0.clone(), t1.clone());
	fe25519_sq(t2, t0.clone());
	fe25519_mul(t1, t1.clone(), t2.clone());
	fe25519_sq(t2, t1.clone());

	for _ in 1..5 {
		fe25519_sq(t2, t2.clone());
	}

	fe25519_mul(t1, t2.clone(), t1.clone());
	fe25519_sq(t2, t1.clone());
	...
	fe25519_mul(t2, t2.clone(), t1.clone());
	fe25519_sq(t3, t2.clone());

	for _ in 1..20 {
		fe25519_sq(t3, t3.clone());
	}

	fe25519_mul(t2, t3.clone(), t2.clone());
	...
	fe25519_mul(out, t1.clone(), t0.clone());
}

pub fn fe25519_frombytes(h: &mut Fe25519, s: &[u8]) {
	let mut h0 = ecdsabase_load4(s) as i64;
	let mut h1 = (ecdsabase_load3(&s[4..]) << 6) as i64;
	let mut h2 = (ecdsabase_load3(&s[7..]) << 5) as i64;
	let mut h3 = (ecdsabase_load3(&s[10..]) << 3) as i64;
	let mut h4 = (ecdsabase_load3(&s[13..]) << 2) as i64;
	let mut h5 = ecdsabase_load4(&s[16..]) as i64;
	let mut h6 = (ecdsabase_load3(&s[20..]) << 7) as i64;
	let mut h7 = (ecdsabase_load3(&s[23..]) << 5) as i64;
	let mut h8 = (ecdsabase_load3(&s[26..]) << 4) as i64;
	let mut h9 = ((ecdsabase_load3(&s[29..]) & 8388607) << 2) as i64;
...
impl Default for Ge25519Precomp{
	fn default() -> Self {
		Self {
...
impl Default for Ge25519Cached{
	fn default() -> Self {
		Self {
			yplusx: Default::default(),
			yminusx: Default::default(),
...
pub fn ge25519_scalarmult_base(h: &mut Ge25519P3, a: &[u8]) {
	let e = &mut [0u8; 64];
	let r = &mut Ge25519P1p1::default();
	let s = &mut Ge25519P2::default();
	let t = &mut Ge25519Precomp::default();
	...
	for i in 0..63 {
		...
		carry = e[i] + 8;
		carry >>= 4;
		e[i] = e[i].wrapping_sub(carry * (1 << 4));
	}
	...
	for i in (1..64).step_by(2) {
		ge25519_cmov8_base(t, i / 2, e[i as usize] as i8);
		ge25519_add_precomp(r, h.clone(), t.clone());
		ge25519_p1p1_to_p3(h, r.clone());
	}

	ge25519_p3_dbl(r, h.clone());
	ge25519_p1p1_to_p2(s, r.clone());
	ge25519_p2_dbl(r, s);
	ge25519_p1p1_to_p2(s, r.clone());
	ge25519_p2_dbl(r, s);
	ge25519_p1p1_to_p2(s, r.clone());
...
pub fn ge25519_p3_tobytes(s: &mut [u8], h: Ge25519P3) {
	let recip = &mut Fe25519::default();
	let x = &mut Fe25519::default();
	let y = &mut Fe25519::default();

	fe25519_invert(recip, h.z);
	fe25519_mul(x, h.x, recip.clone());
	fe25519_mul(y, h.y, recip.clone());
	fe25519_tobytes(s, y.clone());
	s[31] ^= (fe25519_isnegative(x.clone()) << 7) as u8;
}
...
pub fn ge25519_is_canonical(s: &[u8]) -> i32 {
	...
	c = ((c - 1) as u32 >> 8) as u8;
	let d = (((0x000000ED - 1u8).wrapping_sub(s[0]) as u32) as u32 >> 8) as u8;

	return 1 - (c & d & 1) as i32;
}

pub fn ge25519_has_small_order(s: &[u8]) -> i32 {
...
pub fn ge25519_frombytes_negate_vartime(h: &mut Ge25519P3, s: &[u8]) -> i32 {
	let u = &mut Fe25519::default();
	let v = &mut Fe25519::default();
	let v3 = &mut Fe25519::default();
	let vxx = &mut Fe25519::default();
	let mrcheck = &mut Fe25519::default();
	let prcheck = &mut Fe25519::default();

	let mut res = 0;
	fe25519_frombytes(&mut h.y, s);
	fe25519_1(&mut h.z);
	fe25519_sq(u, h.y);
	fe25519_mul(v, u.clone(), ED25519_D);
	/* u = y^2-1 */
	fe25519_sub(u, u.clone(), h.z);
	/* v = dy^2+1 */
	fe25519_add(v, v.clone(), h.z);

	fe25519_sq(v3, v.clone());
	/* v3 = v^3 */
	fe25519_mul(v3, v3.clone(), v.clone());
	fe25519_sq(&mut h.x, v3.clone());
	/* x = uv^7 */
	let hx = h.x.clone();
	fe25519_mul(&mut h.x, hx, v.clone());
	let hx = h.x.clone();
	fe25519_mul(&mut h.x, hx, u.clone());
	/* x = (uv^7)^((q-5)/8) */
	let hx = h.x.clone();
	fe25519_pow22523(&mut h.x, hx);
	let hx = h.x.clone();
	fe25519_mul(&mut h.x, hx, v3.clone());
	let hx = h.x.clone();
	fe25519_mul(&mut h.x, hx, u.clone());
	/* x = uv^3(uv^7)^((q-5)/8) */
	fe25519_sq(vxx, h.x);
	fe25519_mul(vxx, vxx.clone(), v.clone());
	/* vx^2-u */
	fe25519_sub(mrcheck, vxx.clone(), u.clone());

	if fe25519_iszero(mrcheck.clone()) == 0 {
		/* vx^2+u */
		fe25519_add(prcheck, vxx.clone(), u.clone());

		if fe25519_iszero(prcheck.clone()) == 0 {
			res = -1;
		} else {
			let hx = h.x.clone();
	...
	if res != -1 {
		if fe25519_isnegative(h.x) == (s[31] >> 7) as i32 {
			let hx = h.x.clone();
...
pub fn ge25519_add_cached(r: &mut Ge25519P1p1, p: Ge25519P3, q: Ge25519Cached) {
	...
	fe25519_add(&mut r.z, t0.clone(), r.t);
	let rt = r.t.clone();
	fe25519_sub(&mut r.t, t0.clone(), rt);
}

pub fn ge25519_double_scalarmult_vartime(r: &mut Ge25519P2, a: &[u8], a1: Ge25519P3, b: &[u8]) {
	const BI: [Ge25519Precomp; 8] = [
		Ge25519Precomp {
	...
	let aslide = &mut [0i8; 256];
	let bslide = &mut [0i8; 256];
	let ai = &mut [Ge25519Cached::default(); 8];
	let t = &mut Ge25519P1p1::default();
	let u = &mut Ge25519P3::default();
	let a2 = &mut Ge25519P3::default();

	ecdsabase_slide_vartime(aslide, a);
	ecdsabase_slide_vartime(bslide, b);

	ge25519_p3_to_cached(&mut ai[0], a1.clone());

	ge25519_p3_dbl(t, a1);
	ge25519_p1p1_to_p3(a2, t.clone());

	ge25519_add_cached(t, a2.clone(), ai[0]);
	ge25519_p1p1_to_p3(u,t.clone());
	ge25519_p3_to_cached(&mut ai[1], u.clone());

	ge25519_add_cached( t, a2.clone(), ai[1]);
	ge25519_p1p1_to_p3( u, t.clone());
	ge25519_p3_to_cached( &mut ai[2], u.clone());

	ge25519_add_cached( t, a2.clone(), ai[2]);
	ge25519_p1p1_to_p3( u, t.clone());
	ge25519_p3_to_cached( &mut ai[3], u.clone());

	ge25519_add_cached( t, a2.clone(), ai[3]);
	ge25519_p1p1_to_p3( u, t.clone());
	ge25519_p3_to_cached( &mut ai[4], u.clone());

	ge25519_add_cached( t, a2.clone(), ai[4]);
	ge25519_p1p1_to_p3( u, t.clone());
	ge25519_p3_to_cached( &mut ai[5], u.clone());

	ge25519_add_cached( t, a2.clone(), ai[5]);
	ge25519_p1p1_to_p3( u, t.clone());
	ge25519_p3_to_cached( &mut ai[6], u.clone());

	ge25519_add_cached( t, a2.clone(), ai[6]);
	ge25519_p1p1_to_p3( u, t.clone());
	ge25519_p3_to_cached( &mut ai[7], u.clone());
	...
	for i in (0..=j).rev() {
		...
		if aslide[i] > 0 {
			ge25519_p1p1_to_p3(u, t.clone());
			ge25519_add_cached(t, u.clone(), ai[aslide[i] as usize / 2]);
		} else if aslide[i] < 0 {
			ge25519_p1p1_to_p3(u, t.clone());
			ge25519_sub_cached(t, u.clone(), ai[(-aslide[i]) as usize / 2]);
		}

		if bslide[i] > 0 {
			ge25519_p1p1_to_p3(u, t.clone());
			ge25519_add_precomp(t, u.clone(), BI[bslide[i] as usize / 2]);
		} else if bslide[i] < 0	{
			ge25519_p1p1_to_p3(u, t.clone());
			ge25519_sub_precomp(t, u.clone(), BI[(-bslide[i]) as usize / 2]);
		}

		ge25519_p1p1_to_p2(r, t.clone());
	}
}
...
pub fn ge25519_sub_cached(r: &mut Ge25519P1p1, p: Ge25519P3, q: Ge25519Cached) {
	...
	let ry = r.y.clone();
	fe25519_add(&mut r.y, r.z, ry);
	fe25519_sub(&mut r.z, t0.clone(), r.t);
	let rt = r.t.clone();
	fe25519_add(&mut r.t, t0.clone(), rt);
}
...
pub fn sc25519_is_canonical(s: &[u8]) -> i32 {
	...
	while i != 0 {
		i -= 1;
		c |= (((s[i].wrapping_sub(L[i])) as i32) >> 8) & n;
		n &= ((s[i] ^ L[i]).wrapping_sub(1)) as i32 >> 8;
	};
...
pub fn sc25519_muladd(s: &mut [u8], a: &[u8], b: &[u8], c: &[u8]) {
	let a0 = 2097151 & ecdsabase_load3(a) as i64;
	let a1 = 2097151 & (ecdsabase_load4(&a[2..]) >> 5) as i64;
	let a2 = 2097151 & (ecdsabase_load3(&a[5..]) >> 2) as i64;
	let a3 = 2097151 & (ecdsabase_load4(&a[7..]) >> 7) as i64;
	let a4 = 2097151 & (ecdsabase_load4(&a[10..]) >> 4) as i64;
	let a5 = 2097151 & (ecdsabase_load3(&a[13..]) >> 1) as i64;
	let a6 = 2097151 & (ecdsabase_load4(&a[15..]) >> 6) as i64;
	let a7 = 2097151 & (ecdsabase_load3(&a[18..]) >> 3) as i64;
	let a8 = 2097151 & ecdsabase_load3(&a[21..]) as i64;
	let a9 = 2097151 & (ecdsabase_load4(&a[23..]) >> 5) as i64;
	let a10 = 2097151 & (ecdsabase_load3(&a[26..]) >> 2) as i64;
	let a11 = (ecdsabase_load4(&a[28..]) >> 7) as i64;

	let b0 = 2097151 & ecdsabase_load3(b) as i64;
	let b1 = 2097151 & (ecdsabase_load4(&b[2..]) >> 5) as i64;
	let b2 = 2097151 & (ecdsabase_load3(&b[5..]) >> 2) as i64;
	let b3 = 2097151 & (ecdsabase_load4(&b[7..]) >> 7) as i64;
	let b4 = 2097151 & (ecdsabase_load4(&b[10..]) >> 4) as i64;
	let b5 = 2097151 & (ecdsabase_load3(&b[13..]) >> 1) as i64;
	let b6 = 2097151 & (ecdsabase_load4(&b[15..]) >> 6) as i64;
	let b7 = 2097151 & (ecdsabase_load3(&b[18..]) >> 3) as i64;
	let b8 = 2097151 & ecdsabase_load3(&b[21..]) as i64;
	let b9 = 2097151 & (ecdsabase_load4(&b[23..]) >> 5) as i64;
	let b10 = 2097151 & (ecdsabase_load3(&b[26..]) >> 2) as i64;
	let b11 = (ecdsabase_load4(&b[28..]) >> 7) as i64;

	let c0 = 2097151 & ecdsabase_load3(c) as i64;
	let c1 = 2097151 & (ecdsabase_load4(&c[2..]) >> 5) as i64;
	let c2 = 2097151 & (ecdsabase_load3(&c[5..]) >> 2) as i64;
	let c3 = 2097151 & (ecdsabase_load4(&c[7..]) >> 7) as i64;
	let c4 = 2097151 & (ecdsabase_load4(&c[10..]) >> 4) as i64;
	let c5 = 2097151 & (ecdsabase_load3(&c[13..]) >> 1) as i64;
	let c6 = 2097151 & (ecdsabase_load4(&c[15..]) >> 6) as i64;
	let c7 = 2097151 & (ecdsabase_load3(&c[18..]) >> 3) as i64;
	let c8 = 2097151 & ecdsabase_load3(&c[21..]) as i64;
	let c9 = 2097151 & (ecdsabase_load4(&c[23..]) >> 5) as i64;
	let c10 = 2097151 & (ecdsabase_load3(&c[26..]) >> 2) as i64;
	let c11 = (ecdsabase_load4(&c[28..]) >> 7) as i64;
...
pub fn sc25519_reduce(s: &mut [u8; 64]) {
	let mut s0 = 2097151 & ecdsabase_load3(s) as i64;
	let mut s1 = 2097151 & (ecdsabase_load4(&s[2..]) >> 5) as i64;
	let mut s2 = 2097151 & (ecdsabase_load3(&s[5..]) >> 2) as i64;
	let mut s3 = 2097151 & (ecdsabase_load4(&s[7..]) >> 7) as i64;
	let mut s4 = 2097151 & (ecdsabase_load4(&s[10..]) >> 4) as i64;
	let mut s5 = 2097151 & (ecdsabase_load3(&s[13..]) >> 1) as i64;
	let mut s6 = 2097151 & (ecdsabase_load4(&s[15..]) >> 6) as i64;
	let mut s7 = 2097151 & (ecdsabase_load3(&s[18..]) >> 3) as i64;
	let mut s8 = 2097151 & ecdsabase_load3(&s[21..]) as i64;
	let mut s9 = 2097151 & (ecdsabase_load4(&s[23..]) >> 5) as i64;
	let mut s10 = 2097151 & (ecdsabase_load3(&s[26..]) >> 2) as i64;
	let mut s11 = 2097151 & (ecdsabase_load4(&s[28..]) >> 7) as i64;
	let mut s12 = 2097151 & (ecdsabase_load4(&s[31..]) >> 4) as i64;
	let mut s13 = 2097151 & (ecdsabase_load3(&s[34..]) >> 1) as i64;
	let mut s14 = 2097151 & (ecdsabase_load4(&s[36..]) >> 6) as i64;
	let mut s15 = 2097151 & (ecdsabase_load3(&s[39..]) >> 3) as i64;
	let mut s16 = 2097151 & ecdsabase_load3(&s[42..]) as i64;
	let mut s17 = 2097151 & (ecdsabase_load4(&s[44..]) >> 5) as i64;
	let s18 = 2097151 & (ecdsabase_load3(&s[47..]) >> 2) as i64;
	let s19 = 2097151 & (ecdsabase_load4(&s[49..]) >> 7) as i64;
	let s20 = 2097151 & (ecdsabase_load4(&s[52..]) >> 4) as i64;
	let s21 = 2097151 & (ecdsabase_load3(&s[55..]) >> 1) as i64;
	let s22 = 2097151 & (ecdsabase_load4(&s[57..]) >> 6) as i64;
	let s23 = (ecdsabase_load4(&s[60..]) >> 3) as i64;
...
pub fn qrc_sc25519_verify(x: &[u8], y: &[u8], n: usize) -> i32 {
	let mut d = 0;
...
pub fn ed25519_small_order(s: &[u8]) -> i32 {
	/*
...
fn ecdsabase_is_zero(n: &[u8], nlen: usize) -> i32 {
	let mut d = 0;
	...
	return 1 & (((d as u32).wrapping_sub(1)) >> 8) as i32;
}

fn ecdsabase_load3(i: &[u8]) -> u64 {
	let mut res = i[0] as u64;
	res |= (i[1] as u64) << 8;
	res |= (i[2] as u64) << 16;
...
fn ecdsabase_slide_vartime(r: &mut [i8], a: &[u8]) {
	for i in 0..256 {
...
fn fe25519_pow22523(out: &mut Fe25519, z: Fe25519) {
	let t0 = &mut Fe25519::default();
	let t1 = &mut Fe25519::default();
	let t2 = &mut Fe25519::default();
	...
	fe25519_mul(t1, z, t1.clone());
	fe25519_mul(t0, t0.clone(), t1.clone());
	fe25519_sq(t0, t0.clone());
	fe25519_mul(t0, t1.clone(), t0.clone());
	fe25519_sq(t1, t0.clone());
	...
	fe25519_mul(t1, t1.clone(), t0.clone());
	fe25519_sq(t2, t1.clone());
...
fn ge25519_cmov8(t: &mut Ge25519Precomp, precomp: [Ge25519Precomp; 8], b: i8) {
	let minust = &mut Ge25519Precomp::default();
	let bnegative = ecdsabase_negative(b);
	let babs = b - (((-(bnegative as i8)) & b) * ( 1 << 1));
	...
	ge25519_cmov(t, minust.clone(), bnegative);
}

fn ge25519_cmov8_base(t: &mut Ge25519Precomp, pos: i32, b: i8) {
	const BASE: [[Ge25519Precomp; 8]; 32] = [
		[ /* 0/31 */
			Ge25519Precomp {
				yplusx: [ 25967493, -14356035, 29566456, 3660896, -12694345, 4014787, 27544626, -11754271, -6079156, 2047605 ],
				yminusx: [ -12545711, 934262, -2722910, 3049990, -727428, 9406986, 12720692, 5043384, 19500929, -15469378 ],
...
fn ge25519_p2_dbl(r: &mut Ge25519P1p1, p: &mut Ge25519P2) {
	let t0 = &mut Fe25519::default();
	...
	fe25519_sub(&mut r.x, t0.clone(), r.y);
	let rt = r.t.clone();
