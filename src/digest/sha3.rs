...
* #define MSGLEN 200
* uint8_t msg[MSGLEN] = {...};
* uint8_t hash[QRC_SHA3_512_HASH_SIZE] = { 0 };
* qrc_keccak_state ctx;
*
* qrc_sha3_initialize(ctx.state);
*
* qrc_sha3_update(&ctx, qrc_keccak_rate_512, msg, MSGLEN);
*
* qrc_sha3_finalize(&ctx, qrc_keccak_rate_512, hash);
*
* \endcode
*
...
* #define MSGLEN 200
* uint8_t msg[MSGLEN] = {...};
* uint8_t key[QRC_KMAC_256_KEY_SIZE] = {...};
* uint8_t cust[...] = {...};
* qrc_keccak_state ctx;
* uint8_t code[QRC_KMAC_256_MAC_SIZE] = { 0 };
*
* qrc_kmac_initialize(&ctx, qrc_keccak_rate_256, key, sizeof(key), cust, sizeof(cust));
* 	qrc_kmac_update(&ctx, qrc_keccak_rate_256, msg, MSGLEN);
* qrc_kmac_finalize(&ctx, qrc_keccak_rate_256, code, sizeof(code));
*
* \endcode
*
...
*
* uint8_t output[64] = { 0 };
* uint8_t key[QRC_KMAC_512_KEY_SIZE] = {...};
* uint8_t cust[...] = {...};
* uint8_t name[...] = {...};
* qrc_keccak_state ctx;
*
* qrc_cshake_initialize(&ctx, key, sizeof(key), name, sizeof(name), cust, sizeof(cust));
* qrc_cshake_squeezeblocks(&ctx, output, 1);
* \endcode
*
* \remarks
* \par
...
* for example; qrc_sha3_compute512(uint8_t* output, const uint8_t* message, size_t msglen),
...
* SHAKE_256_KEY is the minimum expected SHAKE-256 key size in bytes, QRC_KMAC_512_MAC_SIZE is the minimum size of the KMAC-512 output mac-code output array,
* and QRC_KECCAK_512_RATE is the SHA3-512 message absorption rate.
*
